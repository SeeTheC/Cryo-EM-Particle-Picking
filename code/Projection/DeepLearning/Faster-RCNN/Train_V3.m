...
smallestImageDimension= 250; % used in faster RCNN
...
trainingData = trainDataset(1:4000,:);
valData = trainDataset(4000+1:end,:);
%% Creating Arch
%[layers,options,minInputDim]=createRCNNArchAlexNet(2,savemodel);
%[layers,options,minInputDim]=createRCNNArch(2,savemodel);
%[layers,options,minInputDim]=createRCNNArchVGG16(2,savemodel);
[layers,options,minInputDim]=createRCNNArchInceptionNet(2,savemodel);
...
layers
%% Tuning Trainging Parameter
% Object size 216,216
maxImgSize=1000;
downsampleRate= floor(maxImgSize/smallestImageDimension);
numRegionsToSample=500; % Default: 128
minBoxSizes=[ 216, 216;...
              216, 280;...
              200, 280;...
              300, 280;...
...
minBoxSizes=minBoxSizes./downsampleRate;
boxPyramidScale=1.2; % Default 2 val=[1,2]
numBoxPyramidLevels=6; % Default: Auto
...
if trainNewModel
    ...
    detector = trainFasterRCNNObjectDetector(trainingData, ...
        ...
        'BoxPyramidScale', boxPyramidScale,...
        'NumBoxPyramidLevels',numBoxPyramidLevels,...
        'MinBoxSizes',minBoxSizes....
    );

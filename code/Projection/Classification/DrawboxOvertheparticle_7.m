...
basepath=strcat(basepath,'/_data-Y,Z','v.10','/Noisy_downscale20');
%basepath=strcat(basepath,'/_data-proj-2211','v.20','/Noisy_downscale20');
%basepath=strcat(basepath,'/_data-proj-5689','v.20','/Noisy_downscale20');

collage='1';
trainPath=strcat(basepath,'/train','/collage1_6x6');
testPath=strcat(basepath,'/test','/collage1_6x6');

testCollageRawPath= strcat(testPath,'/processed_img/',collage);
...
lineWidth=2;predictColor='green';
...
title('\fontsize{10}{\color{magenta}EM-5693. Green is true location. Red is predicted.}');
%% Save Center mark
